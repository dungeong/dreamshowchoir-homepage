...
const menuItems = [
    { name: '방명록', href: '/community/guestbook' },
    { name: '문의하기', href: '/community/inquiry' },
    { name: '자주 묻는 질문', href: '/community/faq' },
];
...
export function CommunityLayout({ children }: { children: React.ReactNode }) {
    ...
    // Use startsWith for inquiry details pages, etc.
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-primary py-20 text-center text-primary-foreground">
                <h1 className="text-4xl font-bold mb-4">소통하기</h1>
