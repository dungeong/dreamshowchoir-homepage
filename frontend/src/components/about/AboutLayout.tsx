    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-primary py-20 text-center text-primary-foreground">
                <h1 className="text-4xl font-bold mb-4">드림쇼콰이어 소개</h1>
                <p className="opacity-90">Dream Show Choir Introduction</p>
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="w-full lg:w-64 flex-shrink-0">
                        <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                            <h2 className="text-xl font-bold mb-6 px-4 border-b pb-4">소개</h2>
